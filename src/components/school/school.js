    ...
    render() {
        ...
        if (employeeslist && employeeslist.length > 0 || employeeslist == '') {
            ...
            <div>
                ...
                <h2>School List</h2>
                <Link variant="primary" to="/school/addschool">Add School</Link>
                    ...
                    <tbody>
                        {employeeslist.map(emp => (
                            <tr key={emp.Id}>
                                ...
                                <td>{emp.Adress}</td>
                                <td>
                                    <Link variant="info" to={"/school/editschool/" + emp.Id}>Edit</Link>
                                    
                    &nbsp;<Button variant="danger" onClick={() => this.deleteschool(emp.Id)}>Delete</Button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
