    ...
    render() {
        ...
        if (employeeslist && employeeslist.length > 0) {
            ...
            <div>
                ...
                <h2>Sales List</h2>
                <Link variant="primary" to="/sales/addsales">Add Sales</Link>
                    ...
                    <tbody>
                        {employeeslist.map(emp => (
                            <tr key={emp.Id}>
                                ...
                                <td>{emp.Adress}</td>
                                <td>
                                    <Link variant="info" to={"/sales/editsales/" + emp.Id}>Edit</Link>
                                    
                    &nbsp;<Button variant="danger" onClick={() => this.deletesales(emp.Id)}>Delete</Button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
